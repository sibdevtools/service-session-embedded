...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                packaging = "jar"
                url = "https://github.com/sibdevtools/service-session-embedded"
                ...
                scm {
                    connection.set("scm:https://github.com/sibdevtools/service-session-embedded.git")
                    developerConnection.set("scm:git:ssh://github.com/sibdevtools")
                    url.set("https://github.com/sibdevtools/service-session-embedded")
                }
