...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                packaging = "jar"
                url = "https://github.com/simple-mocks/service-session-embedded"
                ...
                scm {
                    connection.set("scm:https://github.com/simple-mocks/service-session-embedded.git")
                    developerConnection.set("scm:git:ssh://github.com/simple-mocks")
                    url.set("https://github.com/simple-mocks/service-session-embedded")
                }
